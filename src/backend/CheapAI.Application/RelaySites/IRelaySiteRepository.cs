...
public interface IRelaySiteRepository
{
    ...
    Task<PagedResult<RelaySiteOfferResponse>> GetOffersAsync(ulong siteId, RelaySiteOfferQuery query, CancellationToken cancellationToken = default);
    ...
    Task<RelaySiteOfferResponse> UpsertOfferAsync(ulong siteId, ulong? offerId, RelaySiteOfferUpsertRequest request, ulong? adminUserId, CancellationToken cancellationToken = default);

    Task DeleteOfferAsync(ulong siteId, ulong offerId, ulong? adminUserId, CancellationToken cancellationToken = default);
